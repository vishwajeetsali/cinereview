...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur-md text-zinc-100">
            ...
            {/* Mobile overlay */}
            {menuOpen && (
                <div className="md:hidden fixed inset-0 bg-black/60 z-40 backdrop-blur-sm" onClick={() => setMenuOpen(false)} />
            )}

            {/* Mobile drawer */}
            {menuOpen && (
                <div className="md:hidden fixed top-0 right-0 h-full w-64 bg-zinc-950 border-l border-zinc-800 px-5 py-6 flex flex-col gap-1 z-50 shadow-2xl">
